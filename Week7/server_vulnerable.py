...
STUDENT_ID = {
    "6710301041", "6710301003", "6710301027",
    "6710301036", "6720301001", "6720301002",
}
...
async def get_summary():
    return {
        "remaining_coupons": len(coupon_db) - current_coupon_index,
...
if __name__ == "__main__":
    ...
    # host="0.0.0.0" เพื่อให้เครื่องอื่นในวงเน็ตเดียวกันเชื่อมต่อเข้ามาได้
