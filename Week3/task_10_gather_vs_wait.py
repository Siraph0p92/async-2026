...
async def main():
    # Case A: Using gather() -> We must wait for all items to finish to get the ordered list
    ...
    # Case B: Using wait() -> We can decouple early as soon as a condittion matches
    ...
    # ยกเลิก Tasks ที่ยังทำงานไม่เสร็จหลักจากได้ผู้ชนะแล้ว 
    for t in pending:
        t.cancel()
