...
async def main():
    ...
    # asyncio.gather fires items concurrently and collects responses into a single ordered list
    ...
    print(f"{ctime()} Execution Completed in: {time() - start:.2f} seconds") # Expected : ~1.0 seconds 
